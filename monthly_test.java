...
public class monthly_test implements exam_type {
    ...
    public void take_exam_choice(int current_id) {
        ...
        String query = "SELECT * FROM monthly_test WHERE exam_id='" + num + "' ";
        try {
            Statement statement = conn.createStatement();
