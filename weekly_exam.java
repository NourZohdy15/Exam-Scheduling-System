...
public class weekly_exam implements examoperation {
    ...
    public void addexam() {
        ...
        String query1 = "INSERT into weekly_exam(exam_id, subject, mark, grade) Values(?,?,?,?)";
    ...
    public void editexam() {
        ...
        String query2 = "UPDATE weekly_exam SET subject = ?, mark = ?, grade = ? WHERE exam_id = ?";
        try {
    ...
    public void deleteexam() {
        ...
        JDBC weekly_exam_connection = new JDBC();
        Connection connection3 = weekly_exam_connection.OpenConnection();
        String query2 = "DELETE FROM weekly_exam WHERE exam_id= ?";
        try {
    ...
    public void Display_Exams() {
        System.out.println("Weekly Exam List Details: ");

        String query2 = "SELECT * FROM weekly_exam";
        try {
