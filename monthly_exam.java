...
public class monthly_exam implements examoperation {
    ...
    public void addexam() {
        ...
        JDBC weekly_exam_connection = new JDBC();
        Connection connection3 = weekly_exam_connection.OpenConnection();
        String query1 = "INSERT into monthly_exam(exam_id, subject, mark, grade) Values(?,?,?,?)";
    ...
    public void editexam() {
        ...
        String query2 = "UPDATE monthly_exam SET subject = ?, mark = ?, grade = ? WHERE exam_id = ?";
        try {
    ...
    public void deleteexam() {
        ...
        JDBC monthly_exam_connection = new JDBC();
        Connection connection3 = monthly_exam_connection.OpenConnection();
        String query2 = "DELETE FROM monthly_exam WHERE exam_id= ?";
        try {
    ...
    public void Display_Exams() {
        System.out.println("Monthly Exam List Details: ");
        String query2 = "SELECT * FROM monthly_exam";
        try {
