...
public class final_test implements exam_type{
    ...
    public void take_exam_choice(int current_id) {
        ...
        String query = "SELECT * FROM final_test WHERE exam_id='" + num + "' ";
        try {
            Statement statement = conn.createStatement();
