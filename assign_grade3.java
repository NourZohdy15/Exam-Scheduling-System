...
public class assign_grade3 extends assign_assignment {
...
//    assignment_data data = new assignment_data();
    ...
    public void assign_function(int grade)
    {
        ...
        System.out.println("assign assignment to grade three");
...
//        data.setDegree(degree);
        ...
        try {
            ...
            System.out.println("assignment assigned to grade three successfully");
//            System.out.println(ex1.toString());
    ...
    public void student_grade()
    {
        ...
        JDBC teacher_connection = new JDBC();
        Connection conn = teacher_connection.OpenConnection();
        String query1 = "SELECT name, mark FROM student WHERE grade = 3";
        try {
    ...
    {
        String query1 = "INSERT into grade3(notification, type) Values(1,?)";
        ...
        try {
            ...
            System.out.println("Notification is sent successfully to grade 3");
//            Display_Exams();
    ...
    public void check_notification(int current_id) {
        ...
        String query = "SELECT notification FROM grade3";
        try {
            Statement statement = conn.createStatement();
